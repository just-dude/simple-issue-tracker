...
<s:i18n name="controller.struts.action.common.pages.main.package">
    <div id="authentication-container" style="display:none">
        <div id="auth-headline" class="text-center">
            ...
            <div id="registration-container" class="auth-block center-block">
                ...
                <button onclick="location.href=${registrationPage}" class="btn btn-sm btn-primary" ><s:text name="registrationButtonText"/></button>
            </div>
        </div>
            
        <div id="success-login-container"
            <div id="success-login-message"></div>
            <button id="logout-button" class="btn btn-sm btn-primary center-block"><s:text name="logoutButtonText"/></button>
