                        ...
                        <div class="card-header">
                            ...
                            <s:i18n name="controller.struts.action.common.pages.admin.package">
                                ...
                                <div class="dropdown" style="display: inline-block;">
                                    <button class="btn btn-primary dropdown-toggle" type="button" id="dropdownMenu2" dataMap-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                      <s:text name="button.add"/>
                                    </button>
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenu2">
                                      <button class="dropdown-item" onclick="location.href='${addMainPageUrlRU}'" type="button">
                                          <s:text name="russianLanguage"/>
                                      </button>
                                      <button class="dropdown-item" onclick="location.href='${addMainPageUrlEN}'" type="button">
                                ...
                                <table class="table table-hover table-condensed">
                                    ...
                                    <tbody>
                                        <s:iterator value="mainPagesList" var="item">
                                            <s:url var="editMainPageUrl" namespace="/admin/main-pages/" action="edit-page-input">
                                            ...
                                            <tr>
                                                ...
                                                <td><s:property value="page.creator.userProfile.surname"/> <s:property value="page.creator.userProfile.name"/></td>
                                                <td><s:property value="page.lastChangingUTCDateTime"/></td>
                                                <td><s:property value="page.lastChanger.userProfile.surname"/> <s:property value="page.lastChanger.userProfile.name"/></td>
                                                    ...
                                                    <s:i18n name="controller.struts.action.common.pages.admin.package">
                                                        ...
                                                        <td>
                                                            <div class="control-group">
                                                                <div class="controls">
                                                                    <button class="btn btn-warning" onclick="location.href='${editMainPageUrl}'">
                                                        ...
                                                        <td>
                                                            <div class="control-group">
                                                                <div class="controls">
                                                                    <button id="removeUser${page.id}" class="btn btn-danger" dataMap-main-page-id="${page.id}">
