                    ...
                    <s:form action="edit-user" theme="bootstrap" name="editUserForm" id="editUserForm">
                        <div class="card">   
                            ...
                            <div class="card-block">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <s:textfield name="user.userAccountChangedData.oldPassword" id="oldPassword" key="userAccountChangedData.oldPassword" />
                                    </div>
                                </div>
                                <!--/row-->
                                <div class="row">
                                    <div class="col-sm-12">
                                        <s:password name="user.userAccountChangedData.password" id="newPassword" key="userAccountChangedData.newPassword" />
                                    </div>
                                </div>
                                <!--/row-->
                                <div class="row">
                                    <div class="col-sm-12">
                                        <s:password name="repeatPassword" id="repeatPassword" key="userAccountChangedData.repeatNewPassword" />
                                    </div>
                                </div>
                                <!--/row-->
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <s:if test="%{user.userProfile.patronymic.isPresent()}">       
                                            <s:textfield name="user.userProfile.patronymic" id="patronymic" key="userProfile.patronymic" value="%{user.userProfile.patronymic.get()}"/>
                                        </s:if>
                                        <s:else>       
                                            <s:textfield name="user.userProfile.patronymic" id="patronymic" key="userProfile.patronymic" value=""/>
                                        </s:else>
                                    </div>
                                </div>
                                <!--/row-->
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <s:select list="%{#{'m':getText('userProfile.sex.male'), 'f':getText('userProfile.sex.female')}}" key="userProfile.sex" 
                                              value="user.userProfile.sex"      name="user.userProfile.sex" id="sex" required="true"/>
                                    </div>
                                </div>
                                <!--/row--> 
