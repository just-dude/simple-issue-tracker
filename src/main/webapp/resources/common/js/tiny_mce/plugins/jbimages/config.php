...
| -------------------------------------------------------------------*/
	...
	$config['img_path'] = '../photo/'.$_GET['section'].'/temp_images/'; // Relative to domain name
	$config['upload_path'] = $_SERVER['DOCUMENT_ROOT'] .  '/photo/'.$_GET['section'].'/temp_images/'; // Physical path. [Usually works fine like this]
